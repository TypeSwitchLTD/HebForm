      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-12 max-w-4xl w-full relative">
        ...
        <div className="space-y-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border transition-all hover:shadow-lg hover:border-gray-200">
                <h2 className="text-2xl font-bold text-gray-800 mb-4 text-center">{t.stepsTitle}</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-600">{t.step2Text}</p>
                    </div>
                    <div>
                        <div className="text-4xl mb-2">🎉</div>
                        <h3 className="font-semibold text-gray-800">{t.step3Title}</h3>
                        <p className="text-sm text-gray-600">{t.step3Text}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl border transition-all hover:shadow-lg hover:border-purple-200 text-center">
                ...
                <div className="flex flex-col items-center space-y-2">
                    <div className="bg-white p-3 rounded-md flex items-center w-full md:w-3/4 shadow-sm">
                        ...
                        <span className="ms-4 text-gray-600">{t.rewardPart1}</span>
                    </div>
                    ...
                    <div className="bg-white p-3 rounded-md flex items-center w-full md:w-3/4 shadow-sm">
                        ...
                        <span className="ms-4 text-gray-600">{t.rewardPart2}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl mt-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-3 text-center">{t.challengeTitle}</h2>
            <p className="text-center text-gray-600 mb-4">{t.challengeSubtitle}</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="bg-gray-50 p-3 rounded-lg"><div className="text-3xl">🚀</div><h4 className="font-semibold mt-1">{t.challengeMetric1}</h4><p className="text-xs text-gray-500">{t.challengeMetric1Desc}</p></div>
                <div className="bg-gray-50 p-3 rounded-lg"><div className="text-3xl">🎯</div><h4 className="font-semibold mt-1">{t.challengeMetric2}</h4><p className="text-xs text-gray-500">{t.challengeMetric2Desc}</p></div>
                <div className="bg-gray-50 p-3 rounded-lg"><div className="text-3xl">⏳</div><h4 className="font-semibold mt-1">{t.challengeMetric3}</h4><p className="text-xs text-gray-500">{t.challengeMetric3Desc}</p></div>
                <div className="bg-gray-50 p-3 rounded-lg"><div className="text-3xl">😤</div><h4 className="font-semibold mt-1">{t.challengeMetric4}</h4><p className="text-xs text-gray-500">{t.challengeMetric4Desc}</p></div>
            </div>
        </div>
